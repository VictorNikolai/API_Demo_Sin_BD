...
# Lista de diccionarios ... <-- Jason
users = [
    {'id': 1, 'name': 'Leonardo', 'lastname': 'Mejia', 'email': 'leonardo.mejia@example.com', 'age': 26},
    {'id': 2, 'name': 'Magno', 'lastname': 'Luque', 'email': 'magno.luque@example.com', 'age': 27},
    {'id': 3, 'name': 'Arny', 'lastname': 'Salazar', 'email': 'arny.salazar@example.com', 'age': 28},
]


# --> https ://estudiantes.upch.pe/users
